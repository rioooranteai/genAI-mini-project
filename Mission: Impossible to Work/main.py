...
temperature = st.sidebar.slider("Set Your OpenAI Temperature", 0, 10, 5,  help=slider_helper_text)

if st.sidebar.button("Generate Excused", key="sidebar_button"):
    response = langchain_helper.text_generator(media, job, category, temperature)
